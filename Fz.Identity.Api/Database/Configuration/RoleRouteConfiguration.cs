  ...
  public void Configure(EntityTypeBuilder<RoleRoute> builder)
  {
    ...
    builder
      .HasData([
        ...
        new() { RouteId = 84, RoleId = Guid.Parse("66818ace-8c12-4588-be9a-0343922e7623") },
        ...
        new() { RouteId = 117, RoleId = Guid.Parse("8149C0B3-18DB-4C79-8DF3-81300B7C5CFB") },
        new() { RouteId = 118, RoleId = Guid.Parse("8149C0B3-18DB-4C79-8DF3-81300B7C5CFB") },
        new() { RouteId = 120, RoleId = Guid.Parse("8149C0B3-18DB-4C79-8DF3-81300B7C5CFB") },
        new() { RouteId = 120, RoleId = Guid.Parse("07D4316E-4834-48FD-8AFD-A96524C615ED") },
        new() { RouteId = 126, RoleId = Guid.Parse("d502d91b-7514-4e87-81e5-173584c7bd4a") },
        new() { RouteId = 128, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 129, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 130, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 131, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 132, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 133, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 134, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 135, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 136, RoleId = Guid.Parse("bc59a574-4972-41d7-92a9-fdfbef4aad8a") },
        new() { RouteId = 128, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 129, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 130, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 131, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 132, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 133, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 134, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 135, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 136, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 137, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 138, RoleId = Guid.Parse("84887d72-147a-47cc-9657-35922654622d") },
        new() { RouteId = 139, RoleId = Guid.Parse("3d57d4de-0231-4d89-9ddc-c31761cc2765") },
        //new() { RouteId = 121, RoleId = Guid.Parse("E8A76B3F-C104-4D69-A6EC-18A392BFCAA5") },
        //new() { RouteId = 122, RoleId = Guid.Parse("E8A76B3F-C104-4D69-A6EC-18A392BFCAA5") },
        //new() { RouteId = 123, RoleId = Guid.Parse("E8A76B3F-C104-4D69-A6EC-18A392BFCAA5") },
        //new() { RouteId = 124, RoleId = Guid.Parse("E8A76B3F-C104-4D69-A6EC-18A392BFCAA5") },
        //new() { RouteId = 125, RoleId = Guid.Parse("E8A76B3F-C104-4D69-A6EC-18A392BFCAA5") },
        new() { RouteId = 148, RoleId = Guid.Parse("8149C0B3-18DB-4C79-8DF3-81300B7C5CFB") },
        new() { RouteId = 149, RoleId = Guid.Parse("8149C0B3-18DB-4C79-8DF3-81300B7C5CFB") },
      ]);
  }
}
