  ...
  public void Configure(EntityTypeBuilder<Route> builder)
  {
    ...
    builder
      .HasData([
        ...
        new() { Id = 75, ApplitionId = 4, Name = "Crear rol", Description = string.Empty, UrlImg = string.Empty, Path = "/role-management/create-rol", ExcludeNav = true, Component = "horol-actionsme" },
