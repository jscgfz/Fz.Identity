  ...
  public void Configure(EntityTypeBuilder<Route> builder)
  {
    ...
    builder
      .HasData([
        ...
        new() { Id = 15, ApplitionId = 8, Name = "Usuarios internos", Description = "Vista de usuarios internos con cambio de estado, regristro y edición.", UrlImg = string.Empty, Path = "/internal-user", ExcludeNav = false, Component = "internalUser", Order = 2 },
        ...
        new() { Id = 17, ApplitionId = 8, Name = "Carrusel de imagenes", Description = "Vista gestor de contenido para el carrousel con cambio de estado, orden, registro y detalle.", UrlImg = string.Empty, Path = "/carousel-images", ExcludeNav = false, Component = "CarrouselImages", Order =1, ParentId = 16 },
        ...
        new() { Id = 19, ApplitionId = 8, Name = "Oficinas", Description = "Vista gestor de contenido para oficinas con cambio de estado, registro y edición.", UrlImg = string.Empty, Path = "/offices", ExcludeNav = false, Component = "offices", Order =3, ParentId = 16 },
        new() { Id = 20, ApplitionId = 8, Name = "Sostenibilidad", Description = "Vista gestor de contenido para sostenibilidad con cambio de estado, registro y edición.", UrlImg = string.Empty, Path = "/sustainability", ExcludeNav = false, Component = "sustainability", Order = 4, ParentId = 16 },
        new() { Id = 21, ApplitionId = 8, Name = "Políticas", Description = "Vista gestor de contenido para polizas con cambio de estado, registro y edición.", UrlImg = string.Empty, Path = "/policies", ExcludeNav = false, Component = "policies", Order = 5, ParentId = 16 },
